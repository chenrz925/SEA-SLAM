    ...
    , mbDeactivateLocalizationMode(false)
{
    ...
    // TODO [Sematic] Start semantic thread
    Semantic* semantic = Semantic::GetInstance();
    semantic->SetTracker(mpTracker);
    semantic->SetAtlas(mpAtlas);

    std::cout << "==========Semantic Instance=================" << std::endl;
    ROS_INFO("==========Semantic Instance=================");
}
...
void System::Shutdown()
{
    ...
    // mpTracker->opticalFlowThread.get();
