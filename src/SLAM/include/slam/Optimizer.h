...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        void static GlobalBundleAdjustemntForInitialMono(Map* pMap, int nIterations = 5, bool *pbStopFlag = NULL,
                                           const unsigned long nLoopKF = 0, const bool bRobust = true);
        ...
        // int static PoseOptimizationWithDynamic(Frame *pFrame);
        ...
        int static PoseOptimizationWithRelative(Frame* pFrame);
        ...
        // void static LocalBundleAdjustment(KeyFrame *pKF, bool* pbStopFlag, Map* pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
        // void static LocalInertialBA(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool bLarge, bool bRecInit);
        void static ObjectOptimization(Frame* pLastFrame,Frame* pFrame,Cluster* pCluster);
        int static PoseOptimizationWithRelativeFeature(Frame* pFrame);
    
        static WeightCalculation* mWeightCalcu;
