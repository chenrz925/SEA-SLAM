...
int main(int argc, char **argv)
{
    ...
    if(argc < 6||argc>7)
    {
        cerr << endl << "Usage: ./stereo_inertial_kitti path_to_vocabulary path_to_settings path_to_sequence path_to_imudata path_to_imutime saving_path" << endl;
        return 1;
    }
    ...
    if(argc==7)
        cout << "argv[6] result path:: " << argv[6] << endl;
    cout << "===========================" << endl;
    ...
    if (argc == 7)
    {
        ...
        Config::GetInstance()->createSavePath(string(argv[6]));
    }
    else
    {
